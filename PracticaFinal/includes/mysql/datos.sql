...
('Eventia', 'eventia@eventia.es', 'dummyhash', 'promotor', 0, 'aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa'),
('UA', 'ua@eventia.es', 'dummyhash2', 'promotor', 0, 'bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb');
...
(1, 'Dudas sobre el Festival Indie 2025', 'user', '¿Cuánto tiempo antes debo llegar para conseguir un buen lugar?', 4, '2025-05-10 18:00:00', NULL),
(2, 'Dudas sobre el musical El Rey León', 'user', '¿Alguien sabe si hay descuentos para grupos?', 6, '2025-06-15 15:00:00', NULL),
(3, 'Dudas sobre el musical El Rey León', 'admin', 'Sí, hay descuentos para grupos de más de 10 personas. ¡Te recomiendo que llames al teatro para más información!', 6, '2025-06-15 16:00:00', 2),
(4, 'Dudas sobre el musical El Rey León', 'admin', 'Además de los descuentos, también ofrecen un paquete familiar con acceso a actividades especiales.', 6, '2025-06-15 16:30:00', 2),
(5, 'Recomendaciones para el concierto de Coldplay', 'admin', 'Les recomiendo llegar temprano para la mejor experiencia. ¡No se lo pierdan!', 5, '2025-05-09 19:30:00', NULL);
